  ...
  return (
    <div id={id} className={`border-black border-t-2 h-[90vh] w-screen bg-lime-200 flex flex-col justify-evenly px-16 py-8 ${className}`}>
      ...
      <a 
        ...
        className='group self-start bg-green-500 border-black border-t-2 border-l-2 border-r-8 border-b-8 rounded-lg flex flex-row gap-4 px-3 py-6 cursor-pointer hover:bg-green-600 transition-colors duration-200'
      >
